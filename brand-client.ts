...
export namespace admin {
    ...
    export interface AdminDeliverableSubmission {
        id: string
        enrollmentId: string
    ...
    export interface ListAdminDeliverablesParams {
...
export namespace enrollments {
    ...
    export interface Enrollment {
        ...
        updatedAt: string
        /**
         * Deliverables to submit (simplified for shopper UI)
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "hypedrive-2usi-Generated-TS-Client (Encore/v1.53.2)";
        }
