				...
				{mobileMenuOpen && (
					<div className="md:hidden border-t border-stroke-soft-200 py-3 space-y-1">
						...
						<div className="pt-2 px-4">
							<Button.Root variant="neutral" size="small" asChild className="w-full">
								<Link href="/sign-in">Sign In</Link>
							</Button.Root>
						</div>
					</div>
				...
				<div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
					...
					<div>
						...
						<div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-success-lighter ring-1 ring-inset ring-success-base/20 mb-6">
							...
							<span className="text-label-xs text-success-dark">500+ brands trust Hypedrive</span>
						</div>
						...
						<p className="mt-6 text-paragraph-lg text-text-sub-600 max-w-lg leading-relaxed">
							Launch campaigns, verify enrollments with OCR, and manage payouts — all in one
							platform built for modern brands.
						</p>
						...
						<div className="mt-10 flex items-center gap-4 pt-6 border-t border-stroke-soft-200">
							...
							<div>
								...
								<p className="text-paragraph-xs text-text-sub-600 mt-0.5">from 200+ reviews</p>
							</div>
						</div>
					</div>
							...
							<div className="rounded-xl bg-bg-white-0 p-3 shadow-md ring-1 ring-stroke-soft-200">
								<div className="flex items-center gap-3">
									<div className="flex items-center justify-center size-10 rounded-full bg-success-lighter">
										<ChartLineUp weight="duotone" className="size-5 text-success-base" />
									</div>
									<div>
										<p className="text-label-sm text-text-strong-950 font-semibold">+45%</p>
						...
						<div className="absolute -right-4 bottom-1/4 hidden lg:block">
							<div className="rounded-xl bg-bg-white-0 p-3 shadow-md ring-1 ring-stroke-soft-200">
								<div className="flex items-center gap-3">
									...
									<div>
										<p className="text-label-sm text-text-strong-950 font-semibold">2 min</p>
										<p className="text-paragraph-xs text-text-sub-600">Avg. approval</p>
									</div>
								</div>
							</div>
						</div>
					...
					{stats.map((stat) => (
						...
						>
							<div className="flex items-center justify-center size-12 rounded-xl bg-bg-weak-50">
								<stat.icon weight="duotone" className="size-6 text-text-sub-600" />
							</div>
							<div>
								<div className="text-title-h5 text-text-strong-950 font-semibold">{stat.value}</div>
								<div className="text-paragraph-sm text-text-sub-600">{stat.label}</div>
							</div>
						</div>
					))}
				</div>
			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				...
				<div className="max-w-2xl mb-14">
					...
					<p className="mt-4 text-paragraph-lg text-text-sub-600">
						From campaign creation to payout management, Hypedrive handles the entire workflow.
					</p>
				</div>
					...
					{features.map((feature) => {
						...
						return (
							...
							>
								...
								>
									<feature.icon weight="duotone" className={cn("size-6", colors.icon)} />
								</div>
						...
						<div key={step.number} className="relative">
							...
							<div className="text-center">
								...
								<div className="flex items-center justify-center size-12 rounded-xl bg-primary-lighter mx-auto mb-4">
									<step.icon weight="duotone" className="size-6 text-primary-base" />
								</div>

								<h3 className="text-label-md text-text-strong-950 mb-2">{step.title}</h3>
								<p className="text-paragraph-sm text-text-sub-600 leading-relaxed">
									{step.description}
								</p>
							</div>
				...
				<div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
					...
					<div>
						...
						<p className="mt-4 text-paragraph-lg text-text-sub-600 leading-relaxed">
							Monitor campaign performance, enrollment trends, and financial metrics in one
							beautiful dashboard.
						</p>
						...
						<div className="mt-8 space-y-4">
							{[
								...
								<div key={item} className="flex items-start gap-3">
									...
									<span className="text-paragraph-md text-text-sub-600">{item}</span>
								</div>
							))}
						</div>
					...
					<div className="rounded-2xl bg-bg-white-0 p-6 ring-1 ring-inset ring-stroke-soft-200 shadow-sm">
						<div className="flex items-center justify-between mb-6">
							<h3 className="text-label-md text-text-strong-950">Enrollment Overview</h3>
								...
								return (
									<div key={m.label}>
										<div className="flex items-center justify-between mb-2">
											<span className="text-label-sm text-text-sub-600">{m.label}</span>
											<span className={cn("text-label-sm font-semibold", colors.text)}>
												{m.value}
											</span>
										</div>
						...
						<div className="mt-6 pt-5 border-t border-stroke-soft-200 grid grid-cols-3 gap-4">
							<div className="text-center p-3 rounded-xl bg-bg-weak-50">
								<div className="text-title-h6 text-text-strong-950 font-semibold">1,000</div>
								<div className="text-paragraph-xs text-text-sub-600 mt-0.5">Total</div>
							</div>
							<div className="text-center p-3 rounded-xl bg-success-lighter">
								<div className="text-title-h6 text-success-base font-semibold">85%</div>
								<div className="text-paragraph-xs text-text-sub-600 mt-0.5">Approved</div>
							</div>
							<div className="text-center p-3 rounded-xl bg-bg-weak-50">
								<div className="text-title-h6 text-text-strong-950 font-semibold">2m</div>
								<div className="text-paragraph-xs text-text-sub-600 mt-0.5">Avg. Time</div>
							</div>
						</div>
					</div>
				</div>
...
function PricingSection() {
	...
	return (
		<section id="pricing" className="py-20 lg:py-28 bg-bg-weak-50 border-y border-stroke-soft-200">
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				{/* Header */}
					...
					{plans.map((plan) => (
						...
						>
							...
							<div className={cn(plan.popular && "pt-2")}>
								<h3 className="text-label-lg text-text-strong-950">{plan.name}</h3>
