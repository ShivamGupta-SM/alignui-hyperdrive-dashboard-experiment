			...
			<nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				...
				{mobileMenuOpen && (
					<div className="md:hidden border-t border-stroke-soft-200 py-4 space-y-2">
						<Link
							href="#features"
							className="block px-4 py-2 text-label-sm text-text-sub-600 hover:text-text-strong-950 hover:bg-bg-weak-50 rounded-lg transition-colors"
						>
							Features
						</Link>
						<Link
				...
				<div className="text-center">
					...
					<div className="mt-12 sm:mt-16 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 max-w-3xl mx-auto px-2 sm:px-0">
						{MARKETING_STATS.map((stat) => (
							<div
								key={stat.label}
								className="relative p-4 rounded-2xl bg-bg-white-0 ring-1 ring-inset ring-stroke-soft-200"
							>
									...
									<div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 h-full">
										...
										<div className="col-span-2 sm:col-span-4 grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
											{[
												...
												<div
													key={stat.label}
													className="rounded-xl bg-bg-white-0 ring-1 ring-inset ring-stroke-soft-200 p-3 sm:p-4"
												>
													<div
														className={cn(
										...
										<div className="col-span-2 sm:col-span-3 rounded-xl bg-bg-white-0 ring-1 ring-inset ring-stroke-soft-200 p-2 sm:p-4 flex flex-col">
											...
											<div className="flex-1 flex items-end gap-1">
												{[40, 65, 45, 80, 55, 90, 70, 85, 60, 95, 75, 88].map((height) => (
													<div
														key={`bar-${height}`}
														className="flex-1 bg-primary-lighter rounded-t"
														style={{ height: `${height}%` }}
													/>
												))}
											</div>
										...
										<div className="hidden sm:block sm:col-span-1 rounded-xl bg-bg-white-0 ring-1 ring-inset ring-stroke-soft-200 p-2 sm:p-3 space-y-2">
											...
											{[1, 2, 3].map((i) => (
												<div
													key={i}
													className="flex items-center gap-2 p-2 rounded-lg bg-bg-weak-50"
												>
...
function LogosSection() {
	const brands = ["Nike", "Samsung", "Sony", "Adidas", "Puma", "Apple", "Google", "Amazon"]
	...
	const features = [
		{
			...
			description:
				"Create cashback, discount, and loyalty campaigns in minutes with our intuitive 4-step wizard.",
			color: "primary",
		},
		{
			icon: CheckCircle,
			...
			description:
				"OCR-powered enrollment verification automatically extracts order details from receipts.",
			color: "success",
		},
		{
			icon: Wallet,
			...
			description:
				"Real-time balance tracking with automated holds, releases, and instant payouts.",
			color: "feature",
		},
		{
			icon: Users,
			...
			description:
				"Invite team members with role-based access control. Owner, Admin, Manager, or Viewer.",
			color: "information",
		},
		{
			icon: Receipt,
		...
		},
		{
			...
			description:
				"Bank-grade security with 2FA, passkeys, and SOC 2 compliance. Your data is safe.",
			color: "stable",
		},
	]
			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				<div className="text-center mb-16">
					...
					<p className="mt-4 text-paragraph-lg text-text-sub-600 max-w-2xl mx-auto">
						From campaign creation to payout management, Hypedrive handles the entire influencer
						marketing workflow.
					</p>
				</div>
...
function HowItWorksSection() {
	const steps = [
		...
		},
		{
			...
			title: "Verify & Pay",
			description:
				"OCR extracts order details automatically. Approve enrollments and payouts are released instantly.",
		},
	]
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
					<div>
						<div className="inline-flex items-center gap-2 rounded-full bg-information-lighter px-4 py-1.5 mb-4">
							...
							<span className="text-label-xs font-medium text-information-dark">
								Real-time Analytics
							</span>
						</div>
						<h2 className="text-title-h3 sm:text-title-h2 text-text-strong-950">
						...
						<p className="mt-4 text-paragraph-lg text-text-sub-600">
							Monitor campaign performance, enrollment trends, and financial metrics all in one
							beautiful dashboard.
						</p>
						...
						>
							...
							<div className="text-center mb-6">
								...
								<div className="flex items-baseline justify-center gap-1">
									<span className="text-title-h3 text-text-strong-950 font-semibold">
										{plan.price}
									</span>
			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				<div className="text-center mb-16">
					<div className="inline-flex items-center gap-2 rounded-full bg-highlighted-lighter px-4 py-1.5 mb-4">
						...
						<span className="text-label-xs font-medium text-highlighted-dark">
							Customer Stories
						</span>
					</div>
					<h2 className="text-title-h3 sm:text-title-h2 text-text-strong-950">
				...
				<div className="relative rounded-3xl bg-bg-strong-950 p-6 sm:p-10 lg:p-16 overflow-hidden">
					...
					<div className="relative text-center">
						...
						<p className="text-paragraph-lg text-white/70 max-w-2xl mx-auto mb-8">
							Join 500+ brands using Hypedrive to streamline their creator campaigns. Start your
							free trial today.
						</p>
		...
		<footer className="bg-bg-strong-950 text-text-white-0 py-16">
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				<div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 sm:gap-6 lg:gap-8 mb-12">
					<div className="col-span-2">
						...
						<p className="text-paragraph-sm text-white/60 mt-4 max-w-xs">
							The influencer marketing platform that actually works. Launch, manage, and scale
							creator campaigns effortlessly.
						</p>
						<div className="flex items-center gap-4 mt-6">
							<a
								href="https://twitter.com/hypedrive"
								target="_blank"
							...
							<a
								href="https://linkedin.com/company/hypedrive"
								target="_blank"
								rel="noopener noreferrer"
								className="text-white/60 hover:text-white transition-colors"
							...
							<a
								href="https://instagram.com/hypedrive"
								target="_blank"
								rel="noopener noreferrer"
								className="text-white/60 hover:text-white transition-colors"
				...
				<div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
					<p className="text-paragraph-sm text-white/40">© 2025 Hypedrive. All rights reserved.</p>
					<div className="flex items-center gap-6">
						<Link
							href="/privacy"
							className="text-paragraph-sm text-white/40 hover:text-white transition-colors"
						>
							Privacy Policy
						</Link>
						<Link
