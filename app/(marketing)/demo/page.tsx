		...
		<main className="min-h-screen bg-bg-weak-50">
				...
				<nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					<div className="flex h-16 items-center justify-between">
						...
						<div className="inline-flex items-center gap-2 rounded-full bg-primary-lighter px-4 py-1.5">
							...
							<span className="text-label-xs font-medium text-primary-dark">
								Liquid Metal Demos
							</span>
						</div>
					</div>
			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
				...
				<div className="text-center mb-12">
					<h1 className="text-title-h2 text-text-strong-950 mb-4">Liquid Metal Logo Effects</h1>
					<p className="text-paragraph-lg text-text-sub-600 max-w-2xl mx-auto">
						Three different implementations of liquid chrome/metal logo effects using various web
						technologies.
					</p>
				</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div>
							<div className="flex items-center justify-between mb-2">
								...
								<span className="text-paragraph-sm text-text-strong-950 font-medium">
									{speed.toFixed(1)}x
								</span>
							</div>
							<input
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
					...
					<div className="bg-bg-white-0 rounded-2xl p-8 shadow-custom-md ring-1 ring-stroke-soft-200">
						...
						<div className="relative aspect-square w-full max-w-64 mx-auto rounded-xl bg-gradient-to-br from-bg-weak-50 to-bg-soft-200 flex items-center justify-center overflow-hidden">
							<LavaLiquidLogo className="size-48" speed={speed} intensity={intensity} />
						</div>
					...
					<div className="bg-bg-white-0 rounded-2xl p-8 shadow-custom-md ring-1 ring-stroke-soft-200">
						...
						<div className="relative aspect-square w-full max-w-64 mx-auto rounded-xl bg-gradient-to-br from-bg-weak-50 to-bg-soft-200 flex items-center justify-center overflow-hidden">
							<WebGLLiquidLogo className="size-48" speed={speed} intensity={intensity} />
						</div>
					...
					<div className="bg-bg-white-0 rounded-2xl p-8 shadow-custom-md ring-1 ring-stroke-soft-200">
						...
						<div className="relative aspect-square w-full max-w-64 mx-auto rounded-xl bg-gradient-to-br from-bg-weak-50 to-bg-soft-200 flex items-center justify-center overflow-hidden">
							<LiquidMetalLogo className="size-48" speed={speed} intensity={intensity} />
						</div>
						...
						<tbody>
							<tr className="border-b border-stroke-soft-200">
								...
								<td className="py-3 px-4">
									<span className="text-success-base">Excellent</span>
								</td>
								<td className="py-3 px-4 text-paragraph-sm text-text-sub-600">~3KB</td>
								<td className="py-3 px-4">
									<span className="text-success-base">Universal</span>
								</td>
							</tr>
							<tr className="border-b border-stroke-soft-200">
								...
								<td className="py-3 px-4">
									<span className="text-warning-base">Modern only</span>
								</td>
							</tr>
							<tr>
								...
								<td className="py-3 px-4">
									<span className="text-warning-base">Good</span>
								</td>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div>
							...
							<p className="text-paragraph-sm text-text-sub-600">
								Uses the metaball formula (r²/d²) to create organic blob merging. 11 blobs with
								orbital motion and random wobble create the signature lava lamp effect.
							</p>
						</div>
						<div>
							<h3 className="text-label-md text-text-strong-950 mb-2">WebGL Shaders</h3>
							<p className="text-paragraph-sm text-text-sub-600">
								Pure GLSL fragment shaders with simplex noise and FBM for liquid distortion.
						...
						<div>
							...
							<p className="text-paragraph-sm text-text-sub-600">
								Animates SVG filter primitives (feSpecularLighting, feDiffuseLighting) with GSAP
								timelines for dynamic chrome highlights.
							</p>
						</div>
					</div>
				</div>
			...
			<footer className="border-t border-stroke-soft-200 py-8 mt-12">
				<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
					<p className="text-paragraph-sm text-text-sub-600">
						Visit{" "}
						<Link href="/v1" className="text-primary-base hover:underline">
							/v1
						</Link>{" "}
						to see the logo in action on the marketing page.
					</p>
				</div>
			</footer>
		</main>
