	...
	return (
		<div className="min-h-screen bg-bg-white-0">
			...
			<main className="container mx-auto max-w-4xl px-6 py-12">
				...
				<p className="text-paragraph-sm text-text-sub-600 mb-8">Last updated: December 8, 2024</p>

				<div className="prose prose-slate max-w-none space-y-6">
					<section>
						<h2 className="text-title-h5 text-text-strong-950 mb-3">1. Acceptance of Terms</h2>
						<p className="text-paragraph-md text-text-sub-600">
							By accessing and using Hypedrive, you accept and agree to be bound by the terms and
					...
					<section>
						...
						<p className="text-paragraph-md text-text-sub-600">
							Permission is granted to temporarily use Hypedrive for personal, non-commercial
					...
					<section>
						...
						<p className="text-paragraph-md text-text-sub-600">
							All payments are processed securely. Refunds are subject to our refund policy. You
					...
					<section>
						...
						<p className="text-paragraph-md text-text-sub-600">
							You may not use Hypedrive for any illegal or unauthorized purpose. You must not
					...
					<section>
						...
						<p className="text-paragraph-md text-text-sub-600">
							Hypedrive shall not be liable for any indirect, incidental, special, consequential or
