...
export namespace auth {
    ...
    sessions: Session[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/admin/list-user-sessions`, undefined, {query})
            return await resp.json() as {
    sessions: Session[]
}
        }
    ...
    total: number
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/admin/users`, undefined, {query})
            return await resp.json() as {
    users: User[]
    total: number
}
    ...
    success: boolean
         ...
         */
        public async adminStopImpersonating(params: {
    token: string
}): Promise<{
    success: boolean
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/admin/stop-impersonating`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    success: boolean
         ...
         */
        public async deleteOrganizationRole(roleId: string, params: {
    token: string
}): Promise<{
    success: boolean
}> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/auth/organization/delete-role/${encodeURIComponent(roleId)}`, undefined, {query})
            return await resp.json() as {
    success: boolean
}
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/auth/delete-user`, undefined, {query})
            return await resp.json() as {
    success: boolean
}
        }
    ...
    refreshTokenExpiresAt?: string
         ...
         */
        public async getAccountInfo(params: {
    token: string
}): Promise<{
    user: {
        id: string
    ...
    data: { [key: string]: any }
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/account-info`, undefined, {query})
            return await resp.json() as {
    user: {
        id: string
        name?: string
    ...
    member: Member | null
         ...
         */
        public async getActiveMemberRole(params: {
    token: string
}): Promise<{
    role: string | null
}> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/get-active-member-role`, undefined, {query})
            return await resp.json() as {
    role: string | null
}
        }
    ...
    members: Member[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/full`, undefined, {query})
            return await resp.json() as {
    organization: Organization
    members: Member[]
}
    ...
    invitation: Invitation | null
         ...
         */
        public async getOrganizationRole(roleId: string, params: {
    token: string
}): Promise<{
    role: BetterAuthRoleResponse
}> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/get-role/${encodeURIComponent(roleId)}`, undefined, {query})
            return await resp.json() as {
    role: BetterAuthRoleResponse
}
        }
         ...
         * Get current session
         */
        public async getSession(params: {
    token: string
}): Promise<{
    ...
    user: User | null
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/session`, JSON.stringify(params))
            return await resp.json() as {
    session: Session | null
    user: User | null
}
    ...
    status?: boolean
         ...
         */
        public async listAccounts(params: {
    token: string
}): Promise<{
    accounts: LinkedAccount[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/list-accounts`, undefined, {query})
            return await resp.json() as {
    accounts: LinkedAccount[]
}
        }
    ...
    organizations: Organization[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/list`, undefined, {query})
            return await resp.json() as {
    organizations: Organization[]
}
        }
    ...
    sessions: Session[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/sessions`, undefined, {query})
            return await resp.json() as {
    sessions: Session[]
}
        }
         ...
         */
        public async listUserInvitations(params: {
    token: string
}): Promise<{
    invitations: Invitation[]
}> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/list-user-invitations`, undefined, {query})
            return await resp.json() as {
    invitations: Invitation[]
}
        }
    ...
    success: boolean
         ...
         */
        public async revokeOtherSessions(params: {
    token: string
}): Promise<{
    success: boolean
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/revoke-other-sessions`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    success: boolean
         ...
         * Revoke all sessions
         */
        public async revokeSessions(params: {
    token: string
}): Promise<{
    success: boolean
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/revoke-sessions`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/sign-out`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    totpURI: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/two-factor/totp-uri`, JSON.stringify(params))
            return await resp.json() as {
    totpURI: string
}
        }
    ...
    organization: Organization
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/auth/organization/update`, JSON.stringify(params))
            return await resp.json() as {
    organization: Organization
}
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/auth/update-user`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
...
export namespace campaigns {
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/cancel`)
            return await resp.json() as {
    success: boolean
}
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/complete`)
            return await resp.json() as {
    success: boolean
}
        }
...
export namespace coupons {
    ...
    enrollmentId: string
        ...
        public async deactivateCoupon(id: string): Promise<Coupon> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/admin/coupons/${encodeURIComponent(id)}/deactivate`)
            return await resp.json() as Coupon
        }
    ...
    hasMore: boolean
        ...
        public async reactivateCoupon(id: string): Promise<Coupon> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/admin/coupons/${encodeURIComponent(id)}/reactivate`)
            return await resp.json() as Coupon
        }
...
export namespace organizations {
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/organizations/me`)
            return await resp.json() as {
    data: Organization[]
    total: number
    skip: number
    ...
    hasMore: boolean
         ...
         */
        public async getOrganizationCampaignStats(organizationId: string): Promise<{
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/organizations/${encodeURIComponent(organizationId)}/campaign-stats`)
            return await resp.json() as {
    data: OrganizationCampaignStats[]
    total: number
    skip: number
    ...
    hasMore: boolean
         ...
         * Invite member
         */
        public async inviteMember(organizationId: string, params: InviteMemberRequest): Promise<{
    success: boolean
    invitationId: string
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/organizations/${encodeURIComponent(organizationId)}/members/invite`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
    invitationId: string
}
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/organizations/${encodeURIComponent(id)}/members`)
            return await resp.json() as {
    data: Member[]
    total: number
    skip: number
    ...
    message: string
         ...
         */
        public async switchOrganization(id: string): Promise<{
    success: boolean
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/organizations/${encodeURIComponent(id)}/switch`)
            return await resp.json() as {
    success: boolean
}
        }
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "hypedrive-2usi-Generated-TS-Client (Encore/v1.52.1)";
        }
