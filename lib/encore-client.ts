...
export namespace admin {
	...
	export class ServiceClient {
		...
		public async getSystemConfig(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/admin/system-config`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: SystemConfigItem[]
		...
		public async listActivityLogs(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/admin/activity-logs`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: ActivityLog[]
		...
		public async listPendingKYC(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/admin/kyc/pending`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: PendingKYCShopper[]
		...
		public async setCreditLimit(
			...
			const resp = await this.baseClient.callTypedAPI(
				"POST",
				`/admin/organizations/${encodeURIComponent(organizationId)}/credit-limit`,
				JSON.stringify(params)
			)
			return (await resp.json()) as {
				success: boolean
...
export namespace auth {
	...
	export class ServiceClient {
		...
		public async adminGetUser(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/auth/admin/get-user`, undefined, {
				query,
			})
			return (await resp.json()) as {
				user: UserResponse | null
		...
		public async adminListUsers(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/auth/admin/list-users`, undefined, {
				query,
			})
			return (await resp.json()) as {
				users: UserResponse[]
		...
		public async betterAuthHandler(
			...
			return this.baseClient.callAPI(
				method,
				`/deprecated/better-auth/${path.map(encodeURIComponent).join("/")}`,
				body,
				options
			)
		}
...
export namespace campaigns {
	...
	export class ServiceClient {
		...
		public async getFeaturedCampaigns(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/featured`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: Campaign[]
		...
		public async getPublicCampaign(id: string): Promise<Campaign> {
			...
			const resp = await this.baseClient.callTypedAPI(
				"GET",
				`/campaigns/public/${encodeURIComponent(id)}`
			)
			return (await resp.json()) as Campaign
		}
		...
		public async getTrendingCampaigns(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/trending`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: Campaign[]
		...
		public async listPendingSubmissions(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/submissions/pending`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: DeliverableSubmissionResponse[]
		...
		public async listPublicCampaigns(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/public`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: Campaign[]
		...
		public async searchCampaigns(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/search`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: Campaign[]
...
export namespace coupons {
	...
	export class ServiceClient {
		...
		public async getMyRedemptions(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/me/coupon-redemptions`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: CouponRedemptionRecord[]
...
export namespace enrollments {
	...
	export class ServiceClient {
		...
		public async getEnrollmentDetail(id: string): Promise<EnrollmentDetail> {
			...
			const resp = await this.baseClient.callTypedAPI(
				"GET",
				`/enrollments/${encodeURIComponent(id)}/detail`
			)
		...
		public async listMyEnrollments(params: ListEnrollmentsParams): Promise<{
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/enrollments/me`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: Enrollment[]
...
export namespace integrations {
	...
	export class ServiceClient {
		...
		public async novuBridge(
			...
			return this.baseClient.callAPI(
				method,
				`/novu/${path.map(encodeURIComponent).join("/")}`,
				body,
				options
			)
		}
...
export namespace notifications {
	...
	export class ServiceClient {
		...
		public async getDeliveryAnalytics(params: {
			...
			const resp = await this.baseClient.callTypedAPI(
				"GET",
				`/notifications/analytics/delivery`,
				undefined,
				{ query }
			)
			return (await resp.json()) as {
		...
		public async getDeliveryStatus(transactionId: string): Promise<{
			...
			const resp = await this.baseClient.callTypedAPI(
				"GET",
				`/notifications/${encodeURIComponent(transactionId)}/delivery-status`
			)
			return (await resp.json()) as {
				transactionId: string
				statuses: {
...
export namespace organizations {
	...
	export class ServiceClient {
		...
		public async deleteBankAccount(
			...
			const resp = await this.baseClient.callTypedAPI(
				"DELETE",
				`/organizations/${encodeURIComponent(organizationId)}/bank-accounts/${encodeURIComponent(id)}`
			)
			return (await resp.json()) as {
				success: boolean
			}
		...
		public async removeMember(
			...
			const resp = await this.baseClient.callTypedAPI(
				"DELETE",
				`/organizations/${encodeURIComponent(organizationId)}/members/${encodeURIComponent(visitorUserId)}`
			)
			return (await resp.json()) as {
				success: boolean
			}
		...
		public async requestCreditIncrease(
			...
			const resp = await this.baseClient.callTypedAPI(
				"POST",
				`/organizations/${encodeURIComponent(organizationId)}/request-credit-increase`,
				JSON.stringify(params)
			)
			return (await resp.json()) as {
				success: boolean
		...
		public async setDefaultBankAccount(
			...
			const resp = await this.baseClient.callTypedAPI(
				"POST",
				`/organizations/${encodeURIComponent(organizationId)}/bank-accounts/${encodeURIComponent(id)}/set-default`
			)
			return (await resp.json()) as OrganizationBankAccount
		}
		...
		public async submitOrganizationForApproval(organizationId: string): Promise<{
			...
			const resp = await this.baseClient.callTypedAPI(
				"POST",
				`/organizations/${encodeURIComponent(organizationId)}/submit-for-approval`
			)
			return (await resp.json()) as {
				success: boolean
				message: string
		...
		public async verifyBankAccount(
			...
			const resp = await this.baseClient.callTypedAPI(
				"POST",
				`/organizations/${encodeURIComponent(organizationId)}/bank-accounts/${encodeURIComponent(id)}/verify`
			)
			return (await resp.json()) as OrganizationBankAccount
		}
...
export namespace products {
	...
	export class ServiceClient {
		...
		public async listCategories(params: ListCategoriesParams): Promise<{
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/product-categories`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: ProductCategory[]
...
export namespace shoppers {
	...
	export class ServiceClient {
		...
		public async getEarningsHistory(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/shoppers/me/earnings`, undefined, {
				query,
			})
		...
		public async listShoppers(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/admin/shoppers`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: Shopper[]
...
export namespace wallets {
	...
	export class ServiceClient {
		...
		public async createOrganizationWithdrawal(
			...
			const resp = await this.baseClient.callTypedAPI(
				"POST",
				`/organizations/${encodeURIComponent(organizationId)}/wallet/withdrawals`,
				JSON.stringify(params)
			)
			return (await resp.json()) as Withdrawal
		}
		...
		public async getWithdrawalStats(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/withdrawals/stats`, undefined, {
				query,
			})
		...
		public async listMyWithdrawals(params: {
			...
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI("GET", `/withdrawals/me`, undefined, {
				query,
			})
			return (await resp.json()) as {
				data: Withdrawal[]
