...
export namespace admin {
    ...
    export class ServiceClient {
         ...
         */
        public async approveCampaign(id: string, params: ApproveCampaignRequest): Promise<{
    success: boolean
    message: string
}> {
    ...
    circuitBreakers: { [key: string]: CircuitBreakerStatus }
        ...
        public async getPlatformAnalytics(): Promise<PlatformAnalytics> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/admin/analytics`)
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/admin/system-config`, undefined, {query})
            return await resp.json() as {
    data: SystemConfigItem[]
    total: number
    skip: number
    ...
    message: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/admin/permissions/invalidate-cache`)
            return await resp.json() as {
    success: boolean
    message: string
}
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/admin/kyc/pending`, undefined, {query})
            return await resp.json() as {
    data: PendingKYCShopper[]
    total: number
    skip: number
    ...
    hasMore: boolean
         ...
         * Reject campaign
         */
        public async rejectCampaign(id: string, params: RejectCampaignRequest): Promise<{
    success: boolean
    message: string
}> {
            // Now make the actual call to the API
    ...
    message: string
         ...
         * Reject shopper KYC
         */
        public async rejectShopperKYC(shopperId: string, params: RejectShopperKYCRequest): Promise<{
    success: boolean
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/admin/shoppers/${encodeURIComponent(shopperId)}/reject-kyc`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    rule: PermissionRuleResponse
         ...
         */
        public async updateSystemConfig(key: string, params: UpdateSystemConfigRequest): Promise<{
    success: boolean
    config: SystemConfigItem
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/admin/system-config/${encodeURIComponent(key)}`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
    config: SystemConfigItem
}
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/admin/shoppers/${encodeURIComponent(shopperId)}/verify-kyc`)
            return await resp.json() as {
    success: boolean
}
        }
...
export namespace auth {
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/accept-invitation`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    member: MemberResponse
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/add-member`, JSON.stringify(params))
            return await resp.json() as {
    member: MemberResponse
}
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/add-team-member`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    user: UserResponse
        ...
        /**
         * Get user by ID (admin only) - SDK returns user directly
    ...
    success: boolean
        ...
        /**
         * Update user (admin only) - SDK returns user directly
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/cancel-invitation`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    available: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/check-slug`, JSON.stringify(params))
            return await resp.json() as {
    available: boolean
}
        }
        ...
        /**
         * Create organization - SDK compatible response (flat structure with members array)
         */
    ...
    members: MemberResponse[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/create`, JSON.stringify(params))
            return await resp.json() as {
    id: string
    name: string
    slug: string
    ...
    role: RoleResponse
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/create-role`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
    role: RoleResponse
}
    ...
    team: {
        ...
        createdAt: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/create-team`, JSON.stringify(params))
            return await resp.json() as {
    team: {
        id: string
        name: string
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/delete`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
         ...
         */
        public async deleteOrganizationRole(params: {
    roleId: string
}): Promise<{
    success: boolean
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/delete-role`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    member: MemberResponse | null
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/get-active-member`, undefined, {query})
            return await resp.json() as {
    member: MemberResponse | null
}
        }
         ...
         */
        public async getActiveMemberRole(): Promise<{
    role: string | null
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/get-active-member-role`)
            return await resp.json() as {
    role: string | null
}
        }
        ...
        /**
         * Get full organization details - SDK compatible response (flat structure with members array)
         */
    ...
    members: MemberResponse[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/get-full-organization`, undefined, {query})
            return await resp.json() as {
    id: string
    name: string
    slug: string
    ...
    invitation: InvitationResponse | null
         ...
         */
        public async getOrganizationRole(params: {
    roleId: string
}): Promise<{
    role: RoleResponse
}> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/get-role`, undefined, {query})
            return await resp.json() as {
    role: RoleResponse
}
        }
    ...
    hasPermission: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/has-permission`, JSON.stringify(params))
            return await resp.json() as {
    hasPermission: boolean
}
        }
    ...
    hasPermission: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/check-permission`, JSON.stringify(params))
            return await resp.json() as {
    hasPermission: boolean
}
        }
    ...
    invitation: InvitationResponse
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/invite-member`, JSON.stringify(params))
            return await resp.json() as {
    invitation: InvitationResponse
}
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/leave`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    roles: RoleResponse[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/list-roles`, undefined, {query})
            return await resp.json() as {
    roles: RoleResponse[]
}
        }
    ...
    organizations: OrganizationResponse[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/list`)
            return await resp.json() as {
    organizations: OrganizationResponse[]
}
        }
    ...
    sessions: SessionResponse[]
         ...
         * List team members
         */
        public async listTeamMembers(params: {
    teamId: string
}): Promise<{
    members: MemberResponse[]
}> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/list-team-members`, undefined, {query})
            return await resp.json() as {
    members: MemberResponse[]
}
        }
    ...
    teams: {
        ...
        createdAt: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/list-teams`, undefined, {query})
            return await resp.json() as {
    teams: {
        id: string
        name: string
         ...
         */
        public async listUserInvitations(): Promise<{
    invitations: InvitationResponse[]
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/list-user-invitations`)
            return await resp.json() as {
    invitations: InvitationResponse[]
}
        }
         ...
         * List user's teams
         */
        public async listUserTeams(params: {
    organizationId?: string
}): Promise<{
    teams: {
        id: string
        ...
        createdAt: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/organization/list-user-teams`, undefined, {query})
            return await resp.json() as {
    teams: {
        id: string
        name: string
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/reject-invitation`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/remove-member`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/remove-team`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
         ...
         * Remove team member
         */
        public async removeTeamMember(params: {
    teamId: string
    userId: string
}): Promise<{
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/remove-team-member`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/set-active`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/set-active-team`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/update-member-role`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    organization: OrganizationResponse
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/update`, JSON.stringify(params))
            return await resp.json() as {
    organization: OrganizationResponse
}
        }
    ...
    role: RoleResponse
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/update-role`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
    role: RoleResponse
}
         ...
         * Update team
         */
        public async updateTeam(params: {
    teamId: string
    data: {
        name?: string
        metadata?: { [key: string]: any }
    ...
    team: {
        ...
        createdAt: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/organization/update-team`, JSON.stringify(params))
            return await resp.json() as {
    team: {
        id: string
        name: string
...
export namespace campaigns {
    ...
    export type TerminalStatus = "cancelled" | "completed"
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.createDeliverableSubmission = this.createDeliverableSubmission.bind(this)
            ...
            this.getPublicCampaign = this.getPublicCampaign.bind(this)
        ...
        public async activateCampaign(id: string): Promise<Campaign> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/activate`)
         ...
         */
        public async addCampaignDeliverable(params: AddCampaignDeliverableRequest): Promise<CampaignDeliverableResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaign-deliverables`, JSON.stringify(params))
         ...
         */
        public async addCampaignDeliverablesBatch(campaignId: string, params: {
    deliverables: {
        deliverableId: string
        quantity?: number
        isRequired?: boolean
    ...
    deliverables: CampaignDeliverableResponse[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(campaignId)}/deliverables/batch`, JSON.stringify(params))
            return await resp.json() as {
    deliverables: CampaignDeliverableResponse[]
}
        }
        ...
        public async archiveCampaign(id: string): Promise<Campaign> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/archive`)
            return await resp.json() as Campaign
        }
    ...
    platformFee: number
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/calculate-payout`, JSON.stringify(params))
            return await resp.json() as {
    shopperPayout: number
    brandCost: number
    gstAmount: number
    platformFee: number
         ...
         */
        public async createCampaign(params: CreateCampaignRequest): Promise<Campaign> {
            // Now make the actual call to the API
         ...
         */
        public async createDeliverable(params: CreateDeliverableRequest): Promise<Deliverable> {
            // Now make the actual call to the API
    ...
    campaignDeliverableId: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/deliverable-submissions`, JSON.stringify(params))
    ...
    success: boolean
         ...
         */
        public async duplicateCampaign(id: string, params: {
    newTitle?: string
}): Promise<Campaign> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/duplicate`, JSON.stringify(params))
            return await resp.json() as Campaign
        }
        ...
        public async endCampaign(id: string): Promise<Campaign> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/end`)
            return await resp.json() as Campaign
        }

        /**
         * Get campaign by ID - secured endpoint for campaign owners/org members
         */
         ...
         */
        public async getCampaignDeliverable(id: string): Promise<CampaignDeliverableResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaign-deliverables/${encodeURIComponent(id)}`)
            return await resp.json() as CampaignDeliverableResponse
        }
         ...
         */
        public async getCampaignPerformance(id: string, params: {
    startDate?: string
    endDate?: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/${encodeURIComponent(id)}/performance`, undefined, {query})
        ...
        public async getCampaignStats(id: string): Promise<CampaignStats> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/${encodeURIComponent(id)}/stats`)
        ...
        public async getDeliverable(id: string): Promise<Deliverable> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/deliverables/${encodeURIComponent(id)}`)
            return await resp.json() as Deliverable
        }
         ...
         */
        public async getDeliverableSubmission(id: string): Promise<DeliverableSubmissionResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/deliverable-submissions/${encodeURIComponent(id)}`)
            return await resp.json() as DeliverableSubmissionResponse
        }

        /**
         * Get featured campaigns (most recent active public campaigns from approved orgs)
         */
        public async getFeaturedCampaigns(params: {
    take?: number
}): Promise<{
    data: Campaign[]
    total: number
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/featured`, undefined, {query})
            return await resp.json() as {
    data: Campaign[]
    total: number
    skip: number
    ...
    hasMore: boolean
        ...
        /**
         * Get public campaign by ID - for guests viewing active campaigns from approved orgs
         */
        public async getPublicCampaign(id: string): Promise<Campaign> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/public/${encodeURIComponent(id)}`)
            return await resp.json() as Campaign
        }

        /**
         * Get trending campaigns (most enrollments in last 7 days from approved orgs)
         */
        public async getTrendingCampaigns(params: {
    take?: number
}): Promise<{
    data: Campaign[]
    total: number
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/trending`, undefined, {query})
            return await resp.json() as {
    data: Campaign[]
    total: number
    skip: number
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/${encodeURIComponent(campaignId)}/deliverables`)
            return await resp.json() as {
    data: CampaignDeliverableResponse[]
    total: number
    skip: number
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/deliverables`, undefined, {query})
            return await resp.json() as {
    data: Deliverable[]
    total: number
    skip: number
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/enrollments/${encodeURIComponent(enrollmentId)}/submissions`)
            return await resp.json() as {
    data: DeliverableSubmissionResponse[]
    total: number
    skip: number
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/submissions/pending`, undefined, {query})
            return await resp.json() as {
    data: DeliverableSubmissionResponse[]
    total: number
    skip: number
    ...
    hasMore: boolean
         ...
         * Only returns campaigns from approved organizations
         */
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/public`, undefined, {query})
            return await resp.json() as {
    data: Campaign[]
    total: number
    skip: number
    ...
    reason: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/pause`, JSON.stringify(params))
            return await resp.json() as Campaign
        }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/campaign-deliverables/${encodeURIComponent(id)}`)
            return await resp.json() as {
    success: boolean
}
        }
        ...
        public async resumeCampaign(id: string): Promise<Campaign> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/resume`)
            return await resp.json() as Campaign
        }
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/search`, undefined, {query})
            return await resp.json() as {
    data: Campaign[]
    total: number
    skip: number
    ...
    hasMore: boolean
         ...
         */
        public async submitDeliverableProof(id: string, params: SubmitDeliverableRequest): Promise<DeliverableSubmissionResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/deliverable-submissions/${encodeURIComponent(id)}/submit`, JSON.stringify(params))
            return await resp.json() as DeliverableSubmissionResponse
        }
        ...
        public async submitForApproval(id: string): Promise<Campaign> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/submit`)
            return await resp.json() as Campaign
        }
        ...
        public async unarchiveCampaign(id: string): Promise<Campaign> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/unarchive`)
            return await resp.json() as Campaign
        }
         ...
         */
        public async updateCampaign(id: string, params: UpdateCampaignRequest): Promise<Campaign> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/campaigns/${encodeURIComponent(id)}`, JSON.stringify(params))
            return await resp.json() as Campaign
        }
         ...
         */
        public async updateCampaignDeliverable(id: string, params: {
    quantity?: number
    isRequired?: boolean
    instructions?: string
}): Promise<CampaignDeliverableResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/campaign-deliverables/${encodeURIComponent(id)}`, JSON.stringify(params))
            return await resp.json() as CampaignDeliverableResponse
        }
         ...
         */
        public async updateCampaignPricing(id: string, params: {
    rebatePercentage?: number
    billRate?: number
    platformFee?: number
    bonusAmount?: number
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/campaigns/${encodeURIComponent(id)}/pricing`, JSON.stringify(params))
            return await resp.json() as CampaignPricing
        }

        public async updateCampaignStatus(id: string, params: {
    targetStatus: TerminalStatus
}): Promise<{
    success: boolean
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/campaigns/${encodeURIComponent(id)}/status`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
         ...
         */
        public async updateDeliverable(id: string, params: UpdateDeliverableRequest): Promise<Deliverable> {
            // Now make the actual call to the API
    ...
    warnings: string[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/${encodeURIComponent(id)}/validate`)
            return await resp.json() as {
    isValid: boolean
    errors: string[]
    warnings: string[]
...
export namespace coupons {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.removeCouponFromEnrollment = this.removeCouponFromEnrollment.bind(this)
         ...
         */
        public async applyCoupon(id: string, params: {
    enrollmentId: string
}): Promise<CouponRedemptionRecord> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/coupons/${encodeURIComponent(id)}/apply`, JSON.stringify(params))
    ...
    success: boolean
        ...
        public async getCouponByCode(code: string): Promise<Coupon> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/coupons/code/${encodeURIComponent(code)}`)
            return await resp.json() as Coupon
        }
    ...
    uniqueUsers: number
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/admin/coupons/${encodeURIComponent(id)}/stats`)
            return await resp.json() as {
    timesUsed: number
    redemptionCount: number
    uniqueUsers: number
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/me/coupon-redemptions`, undefined, {query})
            return await resp.json() as {
    data: CouponRedemptionRecord[]
    total: number
    skip: number
    ...
    total: number
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/${encodeURIComponent(campaignId)}/available-coupons`)
            return await resp.json() as {
    coupons: Coupon[]
    total: number
}
         ...
         */
        public async listCouponRedemptions(id: string, params: {
    skip?: number
    take?: number
}): Promise<{
    data: CouponRedemptionRecord[]
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/admin/coupons/${encodeURIComponent(id)}/redemptions`, undefined, {query})
            return await resp.json() as {
    data: CouponRedemptionRecord[]
    total: number
    skip: number
    ...
    message: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/enrollments/${encodeURIComponent(enrollmentId)}/coupon`)
            return await resp.json() as {
    success: boolean
    message: string
}
         ...
         * Update coupon (admin)
         */
        public async updateCoupon(id: string, params: UpdateCouponRequest): Promise<Coupon> {
            // Now make the actual call to the API
...
export namespace enrollments {
    ...
    export interface CreateTestDeliverableRequest {
        name: string
        description?: string
        category?: "review" | "social_post" | "video" | "photo" | "referral" | "other"
        requireLink?: boolean
        requireScreenshot?: boolean
    }
    ...
    export type EnrollmentEventType = "SUBMIT_DELIVERABLES" | "APPROVE" | "REJECT" | "REQUEST_CHANGES" | "PERMANENTLY_REJECT" | "WITHDRAW" | "EXPIRE" | "RESUBMIT"
    ...
    export class ServiceClient {
         ...
         */
        public async approveEnrollment(id: string, params: ApproveEnrollmentRequest): Promise<Enrollment> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/enrollments/${encodeURIComponent(id)}/approve`, JSON.stringify(params))
    ...
    errors: { [key: string]: string }
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/enrollments/batch/approve`, JSON.stringify(params))
            return await resp.json() as {
    approved: number
    failed: number
    errors: { [key: string]: string }
    ...
    errors: { [key: string]: string }
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/enrollments/batch/reject`, JSON.stringify(params))
            return await resp.json() as {
    rejected: number
    failed: number
    errors: { [key: string]: string }
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/deliverables/${encodeURIComponent(id)}`)
            return await resp.json() as {
    success: boolean
}
        }
         ...
         */
        public async exportEnrollments(campaignId: string, params: {
    status?: shared.EnrollmentStatus
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/${encodeURIComponent(campaignId)}/enrollments/export`, undefined, {query})
         ...
         */
        public async extendDeadline(id: string, params: {
    newExpiryDate: string
}): Promise<Enrollment> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/enrollments/${encodeURIComponent(id)}/extend-deadline`, JSON.stringify(params))
            return await resp.json() as Enrollment
        }
        ...
        /**
         * Get detailed enrollment with all relations (for UI detail view)
         */
        public async getEnrollmentDetail(id: string): Promise<EnrollmentDetail> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/enrollments/${encodeURIComponent(id)}/detail`)
    ...
    totalPayouts: number
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/${encodeURIComponent(campaignId)}/enrollment-stats`)
            return await resp.json() as {
    total: number
    awaitingSubmission: number
    awaitingReview: number
    ...
    allowedTransitions: EnrollmentEventType[]
        ...
        public async getScanStatus(scanId: string): Promise<OCRScanResult> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/enrollments/scan-status/${encodeURIComponent(scanId)}`)
         ...
         */
        public async listCampaignEnrollments(campaignId: string, params: {
    skip?: number
    take?: number
    status?: shared.EnrollmentStatus
}): Promise<{
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/campaigns/${encodeURIComponent(campaignId)}/enrollments`, undefined, {query})
            return await resp.json() as {
    data: EnrollmentWithRelations[]
    total: number
    skip: number
    ...
    hasMore: boolean
         ...
         */
        public async rejectEnrollment(id: string, params: RejectEnrollmentRequest): Promise<Enrollment> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/enrollments/${encodeURIComponent(id)}/reject`, JSON.stringify(params))
            return await resp.json() as Enrollment
        }
    ...
    feedback: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/enrollments/${encodeURIComponent(id)}/request-changes`, JSON.stringify(params))
            return await resp.json() as Enrollment
        }
    ...
    screenshotUrl: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/enrollments/scan-order`, JSON.stringify(params))
         ...
         * Submit deliverables
         */
        public async submitDeliverables(id: string, params: SubmitDeliverablesRequest): Promise<Enrollment> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/enrollments/${encodeURIComponent(id)}/submit`, JSON.stringify(params))
            return await resp.json() as Enrollment
        }
         ...
         */
        public async updateDeliverable(id: string, params: {
    proofLink?: string
    proofScreenshot?: string
}): Promise<EnrollmentDeliverable> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/deliverables/${encodeURIComponent(id)}`, JSON.stringify(params))
...
export namespace integrations {
    ...
    export type PlatformType = "marketplace" | "social" | "ecommerce" | "delivery" | "grocery" | "fashion" | "electronics" | "beauty" | "food" | "other"
    ...
    success: boolean
        ...
        public async getPlatformByName(name: string): Promise<Platform> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/platforms/name/${encodeURIComponent(name)}`)
            return await resp.json() as Platform
        }
        ...
        public async listActivePlatforms(): Promise<PlatformsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/platforms/active`)
    ...
    hasMore: boolean
        ...
        /**
         * Health check endpoint for Novu Bridge
         * Used by Novu to verify the bridge is accessible
         */
...
export namespace invoices {
    ...
    reason: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/invoices/${encodeURIComponent(id)}/cancel`, JSON.stringify(params))
         ...
         */
        public async generateInvoice(params: GenerateInvoiceRequest): Promise<Invoice> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/invoices/generate`, JSON.stringify(params))
            return await resp.json() as Invoice
        }
    ...
    pdfUrl: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/invoices/${encodeURIComponent(id)}/pdf`)
            return await resp.json() as {
    pdfUrl: string
}
        }
         ...
         */
        public async getInvoiceLineItems(id: string): Promise<InvoiceLineItemsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/invoices/${encodeURIComponent(id)}/line-items`)
    ...
    hasMore: boolean
        ...
        public async markInvoiceViewed(id: string): Promise<Invoice> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/invoices/${encodeURIComponent(id)}/mark-viewed`)
            return await resp.json() as Invoice
        }
        ...
        public async sendInvoice(id: string): Promise<Invoice> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/invoices/${encodeURIComponent(id)}/send`)
            return await resp.json() as Invoice
        }
    }
}
...
export namespace notifications {
    export type DeliveryStatus = "pending" | "sent" | "delivered" | "failed" | "bounced" | "complained" | "opened" | "clicked"
    ...
    export type NotificationType = "campaign_approved" | "campaign_rejected" | "campaign_started" | "campaign_ended" | "enrollment_approved" | "enrollment_rejected" | "deliverable_approved" | "deliverable_rejected" | "revision_requested" | "payment_received" | "withdrawal_completed" | "withdrawal_failed" | "kyc_verified" | "kyc_rejected" | "invoice_generated" | "invoice_overdue" | "system_announcement" | "general"
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.getDeliveryAnalytics = this.getDeliveryAnalytics.bind(this)
            ...
            this.unsubscribeGet = this.unsubscribeGet.bind(this)
            this.unsubscribeWithToken = this.unsubscribeWithToken.bind(this)
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/notifications/${encodeURIComponent(id)}`)
            return await resp.json() as {
    success: boolean
}
        }
    ...
    clickRate: number
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/notifications/analytics/delivery`, undefined, {query})
            return await resp.json() as {
    total: number
    sent: number
    delivered: number
    ...
    clickRate: number
         ...
         */
        public async getDeliveryStatus(transactionId: string): Promise<{
    ...
    statuses: {
        ...
        failureReason?: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/notifications/${encodeURIComponent(transactionId)}/delivery-status`)
            return await resp.json() as {
    transactionId: string
    statuses: {
        channel: string
    ...
    channels: {
        ...
        enabled: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/notifications/preferences/global`)
            return await resp.json() as {
    enabled: boolean
    channels: {
        type: string
        ...
        public async getNotification(id: string): Promise<Notification> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/notifications/${encodeURIComponent(id)}`)
    ...
    markedCount: number
        ...
        /**
         * Novu Webhook Handler
         * 
         * Configure this URL in Novu Dashboard:
         * https://your-api.hypedrive.in/notifications/webhook/novu
         * 
         * Novu sends webhooks with:
         * - X-Novu-Signature header for verification
    ...
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/notifications/push-token`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
}
        }
    ...
    message: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/notifications/preferences/reset`)
            return await resp.json() as {
    message: string
}
        }
        ...
        /**
         * Resubscribe to email notifications using signed token
         * For users who want to undo their unsubscribe action
         */
        public async resubscribe(params: {
    token: string
}): Promise<{
    success: boolean
    message: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/notifications/resubscribe`, JSON.stringify(params))
            return await resp.json() as {
    success: boolean
    message: string
}
         ...
         */
        public async unregisterPushToken(params: {
    token: string
}): Promise<{
    success: boolean
}> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/notifications/push-token`, undefined, {query})
            return await resp.json() as {
    success: boolean
}
        }
         ...
         * Allows users to unsubscribe by clicking a link in email
         */
        public async unsubscribeGet(params: {
    token: string
}): Promise<{
    success: boolean
    message: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/notifications/unsubscribe`, undefined, {query})
            return await resp.json() as {
    success: boolean
    message: string
}
         ...
         * This endpoint is called from email unsubscribe links
         * Token contains: subscriberId, workflowId (optional), timestamp, signature
         */
        public async unsubscribeWithToken(params: {
    token: string
}): Promise<{
    success: boolean
    message: string
    ...
    channels: {
        ...
        enabled: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/notifications/preferences/global`, JSON.stringify(params))
            return await resp.json() as {
    enabled: boolean
    channels: {
        type: string
         ...
         */
        public async updatePreference(params: UpdatePreferenceRequest): Promise<NotificationPreference> {
            // Now make the actual call to the API
...
export namespace organizations {
    ...
    export interface CreateOrganizationRequest {
         ...
         * Business type
         */
        businessType?: "pvt_ltd" | "llp" | "partnership" | "proprietorship" | "public_ltd" | "trust" | "society" | "other"
    ...
    export interface Organization {
        ...
        email?: string
        /**
         * Aliases for frontend compatibility (standardized field names)
         */
        phone?: string
    ...
    export class ServiceClient {
         ...
         * Create organization
         */
        public async createOrganization(params: CreateOrganizationRequest): Promise<Organization> {
            // Now make the actual call to the API
    ...
    data: OrganizationBankAccount[]
        ...
        /**
         * List invitations for organization (alias for auth.listInvitations)
         */
        public async listInvitations(organizationId: string): Promise<{
    data: {
        id: string
        email: string
        organizationId: string
    ...
    data: {
         ...
         * Remove member
         */
        public async removeMember(organizationId: string, visitorUserId: string): Promise<{
    success: boolean
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/organizations/${encodeURIComponent(organizationId)}/members/${encodeURIComponent(visitorUserId)}`)
            return await resp.json() as {
    success: boolean
}
        }
    ...
    requestId: string
         ...
         */
        public async submitOrganizationForApproval(organizationId: string): Promise<{
    success: boolean
    message: string
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/organizations/${encodeURIComponent(organizationId)}/submit-for-approval`)
            return await resp.json() as {
    success: boolean
    message: string
}
         ...
         * Update organization
         */
        public async updateOrganization(id: string, params: UpdateOrganizationRequest): Promise<Organization> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/organizations/${encodeURIComponent(id)}`, JSON.stringify(params))
            return await resp.json() as Organization
        }
...
export namespace products {
    ...
    errors: string[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/products/batch/import`, JSON.stringify(params))
            return await resp.json() as {
    imported: number
    failed: number
    errors: string[]
         ...
         */
        public async createCategory(params: CreateCategoryRequest): Promise<ProductCategory> {
            // Now make the actual call to the API
    ...
    success: boolean
        ...
        public async getCategoryByName(name: string): Promise<ProductCategory> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/product-categories/name/${encodeURIComponent(name)}`)
            return await resp.json() as ProductCategory
        }
    ...
    hasMore: boolean
         ...
         * PUBLIC ENDPOINT: For unauthenticated users, only returns products from approved orgs
         * AUTHENTICATED: If user is logged in and has org access, returns any product they own
         */
        ...
        public async getProductBySlug(slug: string): Promise<ProductWithStats> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/products/slug/${encodeURIComponent(slug)}`)
            return await resp.json() as ProductWithStats
        }
        ...
        public async listAllCategories(): Promise<ProductCategoriesResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/product-categories/all`)
    ...
    hasMore: boolean
         ...
         */
        public async listProductCampaigns(id: string, params: {
    skip?: number
    take?: number
}): Promise<{
    data: {
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/products/${encodeURIComponent(id)}/campaigns`, undefined, {query})
            return await resp.json() as {
    data: {
        id: string
        title: string
    ...
    hasMore: boolean
         ...
         */
        public async updateCategory(id: string, params: UpdateCategoryRequest): Promise<ProductCategory> {
            // Now make the actual call to the API
         ...
         * Update product
         */
        public async updateProduct(id: string, params: UpdateProductRequest): Promise<Product> {
            // Now make the actual call to the API
...
export namespace shoppers {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.completeAadhaarVerification = this.completeAadhaarVerification.bind(this)
    ...
    error?: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/shoppers/me/kyc/aadhaar/verify`, JSON.stringify(params))
            return await resp.json() as {
    verified: boolean
    error?: string
}
    ...
    rejectionReason?: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/shoppers/me/kyc`)
            return await resp.json() as {
    status: KYCStatus
    panVerified: boolean
    aadhaarVerified: boolean
    ...
    clientId: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/shoppers/me/kyc/aadhaar/initiate`, JSON.stringify(params))
            return await resp.json() as {
    clientId: string
}
        }
...
export namespace wallets {
    ...
    hasMore: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/admin/withdrawals/pending-approval`, undefined, {query})
            return await resp.json() as {
    data: Withdrawal[]
    total: number
    skip: number
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "hypedrive-2usi-Generated-TS-Client (Encore/v1.53.0)";
        }
