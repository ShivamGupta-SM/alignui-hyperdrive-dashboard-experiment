    ...
    return (
        <Card className={cn("w-full max-w-sm", className, classNames?.base)}>
                        ...
                        <>
                            {(credentials || magicLink || emailOTP) && (
                                ...
                                >
                                    ...
                                    />
                                    <span className="flex-shrink-0 text-text-sub-600 text-sm">
            ...
            {credentials && signUp && (
                <CardFooter
                    className={cn(
                        "justify-center gap-1.5 text-text-sub-600 text-sm",
                        classNames?.footer
                    )}
                >
                    {view === "SIGN_IN" ||
                    ...
                    view === "SIGN_UP" ? (
                        <Link
                            className={cn(
                                "text-text-strong-950 underline",
                        ...
                        >
                            <Button
                                ...
                                size="sm"
                                className={cn(
                                    "px-0 text-text-strong-950 underline",
                                    classNames?.footerLink
                                )}
                            >
                                {view === "SIGN_IN" ||
