            ...
            {!hideNav && (
                <div className="flex justify-between gap-2 md:hidden">
                    <Label className="font-semibold text-base">
                        {navItems.find((i: any) => i.view === view)?.label}
                    </Label>
                        ...
                        <DrawerContent>
                            ...
                            <div className="flex flex-col px-4 pb-4">
                                {navItems.map((item: any) => (
                                    <Link
                                        key={item.view}
                                        href={`${organizationOptions?.basePath}${organizationOptions?.pathMode === "slug" ? `/${slug}` : ""}/${organizationOptions?.viewPaths?.[item.view as keyof typeof organizationOptions.viewPaths]}`}
                                    >
                                        <Button
                                            size="lg"
                                            className={cn(
