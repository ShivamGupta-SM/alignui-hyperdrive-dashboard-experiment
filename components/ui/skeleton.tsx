...
interface SkeletonProps extends React.HTMLAttributes<HTMLDivElement>, SkeletonVariantProps {
	width?: string | number
	height?: string | number
}

function Skeleton({ className, variant, width, height, style, ...rest }: SkeletonProps) {
	return (
		<div
...
function SkeletonAvatar({
	...
	return <Skeleton variant="circle" width={size} height={size} className={className} {...rest} />
}
SkeletonAvatar.displayName = "SkeletonAvatar"

function SkeletonCard({ className, ...rest }: React.HTMLAttributes<HTMLDivElement>) {
	return (
		<div
...
function SkeletonButton({
	...
	return <Skeleton className={cn(heights[size], "w-24 rounded-lg", className)} {...rest} />
}
