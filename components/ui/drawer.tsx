...
function DrawerHeader({
	...
	return (
		<div
			className={cn("flex items-center gap-3 border-b border-stroke-soft-200 p-5", className)}
			{...rest}
		>
			{children}
...
function DrawerFooter({ className, ...rest }: React.HTMLAttributes<HTMLDivElement>) {
	return (
		<div
			className={cn("flex items-center gap-4 border-t border-stroke-soft-200 p-5", className)}
