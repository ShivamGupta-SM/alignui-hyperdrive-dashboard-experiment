...
interface GridProps extends React.HTMLAttributes<HTMLDivElement>, GridVariantProps {
	// Responsive columns
...
function Grid({
	...
	return (
		<div
			className={cn(gridVariants({ cols, gap, gapX, gapY }), responsiveClasses, className)}
			{...rest}
		>
			{children}
		</div>
...
interface ColProps extends React.HTMLAttributes<HTMLDivElement>, ColSpanVariantProps {
	// Responsive spans
...
function Col({
	...
	return (
		<div className={cn(colSpanVariants({ span, start }), responsiveClasses, className)} {...rest}>
			{children}
		</div>
	)
}
...
function Divider({ orientation = "horizontal", className, ...rest }: DividerProps) {
	return (
		<div
			className={cn(
				"bg-stroke-soft-200",
...
interface FlexProps extends React.HTMLAttributes<HTMLDivElement>, FlexVariantProps {}

function Flex({ direction, align, justify, wrap, gap, className, children, ...rest }: FlexProps) {
	return (
		<div
