// AlignUI Tooltip v0.1.0
// Improvements: role=tooltip for accessibility, JSDoc documentation
...
/**
 * TooltipContent - The content displayed in the tooltip popup
 *
 * @example
 * <Tooltip.Provider>
 *   <Tooltip.Root>
...
>(({ size, variant, className, children, sideOffset = 4, ...rest }, forwardedRef) => {
