...
type DividerProps = React.HTMLAttributes<HTMLDivElement> &
	VariantProps<typeof dividerVariants> & {
		/** Orientation of the divider for accessibility */
		orientation?: "horizontal" | "vertical"
	}

function Divider({ className, variant, orientation = "horizontal", ...rest }: DividerProps) {
	return (
		<div
			role="separator"
...
export { Divider as Root, type DividerProps }
