	...
	return (
		<DayPicker
			...
			classNames={{
				...
				month: "space-y-2 p-5",
				month_caption: "flex justify-center items-center relative rounded-lg bg-bg-weak-50 h-9",
				...
				today: "day-today",
				outside: "day-outside text-text-disabled-300! aria-[selected]:text-static-white!",
