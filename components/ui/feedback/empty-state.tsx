...
const EmptyStateHeader = React.forwardRef<HTMLDivElement, EmptyStateHeaderProps>(
	({ className, showPattern = true, patternSize = "medium", children, ...rest }, forwardedRef) => {
...
function EmptyStateIcon<T extends React.ElementType = "div">({
	...
	return (
		<Component className={cn(icon({ class: className }), colorClasses[color])} {...rest}>
...
const EmptyStateTitle = React.forwardRef<HTMLHeadingElement, EmptyStateTitleProps>(
	({ className, ...rest }, forwardedRef) => {
		...
		return <h2 ref={forwardedRef} className={title({ class: className })} {...rest} />
	}
)
...
const EmptyStateDescription = React.forwardRef<HTMLParagraphElement, EmptyStateDescriptionProps>(
	({ className, ...rest }, forwardedRef) => {
		...
		return <p ref={forwardedRef} className={description({ class: className })} {...rest} />
	}
)
...
const EmptyStateFooter = React.forwardRef<HTMLDivElement, EmptyStateFooterProps>(
	({ className, ...rest }, forwardedRef) => {
		...
		return <footer ref={forwardedRef} className={footer({ class: className })} {...rest} />
	}
)
