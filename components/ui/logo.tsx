...
export function Logo({
	...
	const logoSrc = isDark ? "/images/hypedrive-logo-dark.svg" : "/images/hypedrive-logo.svg"

	// Icon-only sources (just the arrow symbol)
	const iconSrc = isDark ? "/images/hypedrive-icon-dark.svg" : "/images/hypedrive-icon.svg"
