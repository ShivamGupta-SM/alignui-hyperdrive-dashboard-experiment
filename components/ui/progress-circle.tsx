...
function getSizes({ size }: Pick<VariantProps<typeof progressCircleVariants>, "size">) {
	switch (size) {
		case "80":
			return {
				strokeWidth: 6.4,
...
const ProgressCircleRoot = React.forwardRef<SVGSVGElement, ProgressCircleRootProps>(
	(
		{ value = 0, max = 100, size, className, children, ...rest }: ProgressCircleRootProps,
		forwardedRef
	) => {
