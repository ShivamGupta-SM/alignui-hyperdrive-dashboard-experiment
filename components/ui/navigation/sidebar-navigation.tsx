...
export const sidebarVariants = tv({
	slots: {
		root: ["flex h-full w-72 flex-col", "border-r border-stroke-soft-200 bg-bg-white-0"],
	...
	variants: {
		...
		isActive: {
			true: {
				navItem: ["bg-bg-weak-50 text-text-strong-950", "font-medium"],
...
const SidebarHeader = React.forwardRef<HTMLDivElement, SidebarHeaderProps>(
	({ className, ...rest }, forwardedRef) => {
		...
		return <div ref={forwardedRef} className={header({ class: className })} {...rest} />
	}
)
...
const SidebarContent = React.forwardRef<HTMLDivElement, SidebarContentProps>(
	({ className, ...rest }, forwardedRef) => {
		...
		return <div ref={forwardedRef} className={content({ class: className })} {...rest} />
	}
)
...
const SidebarFooter = React.forwardRef<HTMLDivElement, SidebarFooterProps>(
	({ className, ...rest }, forwardedRef) => {
		...
		return <div ref={forwardedRef} className={footer({ class: className })} {...rest} />
	}
)
...
const SidebarNav = React.forwardRef<HTMLElement, SidebarNavProps>(
	({ className, ...rest }, forwardedRef) => {
		...
		return <nav ref={forwardedRef} className={nav({ class: className })} {...rest} />
	}
)
...
const SidebarNavGroup = React.forwardRef<HTMLDivElement, SidebarNavGroupProps>(
	({ className, ...rest }, forwardedRef) => {
		...
		return <div ref={forwardedRef} className={navGroup({ class: className })} {...rest} />
	}
)
