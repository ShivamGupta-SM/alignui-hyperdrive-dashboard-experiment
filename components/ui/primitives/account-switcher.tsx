...
export const accountSwitcherVariants = tv({
	slots: {
		...
		statusIndicator: ["absolute bottom-0 right-0 size-2.5 rounded-full ring-2 ring-bg-white-0"],
		addButton: [
			// base
					...
					<DropdownMenuPrimitive.Portal>
						...
						>
									...
									{accounts.map((account) => (
										...
										>
											...
											{account.id !== selectedAccountId && (
												<div className={styles.accountItemRadio()} data-selected={false} />
											)}
										</DropdownMenuPrimitive.RadioItem>
									))}
								</DropdownMenuPrimitive.RadioGroup>
							...
							<DropdownMenuPrimitive.Group className="py-1.5">
								<DropdownMenuPrimitive.Item className={styles.menuItem()} onSelect={onSignOut}>
									<div className="flex items-center gap-2">
