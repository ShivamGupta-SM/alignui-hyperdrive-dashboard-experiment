		...
		>
			...
			<defs>
				...
				>
					...
					<feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_36237_4888" />
					<feBlend in="SourceGraphic" in2="effect1_backgroundBlur_36237_4888" result="shape" />
				</filter>
				<filter
					id={filterId2}
					width={42.6}
