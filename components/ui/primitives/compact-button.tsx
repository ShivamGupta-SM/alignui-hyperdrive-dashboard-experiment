...
export const compactButtonVariants = tv({
	slots: {
		root: [
			// base
			"relative flex shrink-0 cursor-pointer items-center justify-center outline-none",
...
interface CompactButtonIconProps extends CompactButtonSharedProps {
...
function CompactButtonIcon({
	...
	// Only accept children - no `as` prop to eliminate serialization issues
