	...
	return (
		...
		>
			...
			<path
				...
				strokeLinecap="round"
			/>
			<path d="M75 15L95 36" stroke="currentColor" strokeOpacity="0.2" strokeWidth="2" />
			{/* Text lines */}
			<rect x="38" y="50" width="44" height="4" rx="2" fill="currentColor" fillOpacity="0.3" />
			<rect x="38" y="62" width="32" height="4" rx="2" fill="currentColor" fillOpacity="0.2" />
			<rect x="38" y="74" width="38" height="4" rx="2" fill="currentColor" fillOpacity="0.2" />
			<rect x="38" y="86" width="24" height="4" rx="2" fill="currentColor" fillOpacity="0.15" />
		</svg>
	)
}
...
export function InboxIllustration({
	...
	return (
		...
		>
			...
			/>
			{/* Inner shadow */}
			<path d="M40 50C40 58 48 65 60 65C72 65 80 58 80 50" fill="currentColor" fillOpacity="0.05" />
		</svg>
	)
}
...
export function LockIllustration({
	...
	return (
		...
		>
			...
			/>
			{/* Keyhole */}
			<circle cx="60" cy="72" r="6" fill="currentColor" fillOpacity="0.3" />
			<rect x="57" y="76" width="6" height="12" rx="2" fill="currentColor" fillOpacity="0.3" />
		</svg>
	)
}
