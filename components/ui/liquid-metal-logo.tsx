...
export function LiquidMetalLogo({
	...
	return (
		<div ref={containerRef} className={`relative ${className}`}>
			...
			<svg className="absolute w-0 h-0" aria-hidden="true">
				<defs>
					...
					<filter id="liquidMetalFilter" x="-20%" y="-20%" width="140%" height="140%">
						...
						<feDiffuseLighting in="blur" surfaceScale="3" diffuseConstant="0.8" result="diffuse">
			...
			<div className="relative w-full h-full" style={{ filter: "url(#liquidMetalFilter)" }}>
				<Image
					src={logoPath}
					alt="Logo"
					fill
...
export function LiquidMetalLogoCanvas({
	...
	return (
		<canvas ref={canvasRef} className={`${className}`} style={{ imageRendering: "crisp-edges" }} />
	)
}
