...
export function MetallicLogo({
	...
	return (
		<div ref={containerRef} className={`relative ${className}`}>
			...
			<svg ref={svgRef} className="absolute w-0 h-0 overflow-hidden" aria-hidden="true">
				<defs>
					{/* Chrome gradient */}
					...
					>
						...
						<feDiffuseLighting in="blurred" surfaceScale="4" diffuseConstant="0.9" result="diffuse">
			...
			<div className="relative w-full h-full" style={{ filter: "url(#liquidMetal)" }}>
				<Image
					src={logoPath}
					alt="Logo"
					fill
