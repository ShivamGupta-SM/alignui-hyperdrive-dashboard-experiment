			...
			{activity.actorAvatar ? (
				<Avatar.Root size="32">
					...
					<Avatar.Indicator position="bottom">
						<div
							className={cn("size-4 rounded-full flex items-center justify-center", config.bgColor)}
						>
	...
	if (error) {
		return (
			<div className={cn("text-center py-8", className)}>
				<p className="text-paragraph-sm text-text-soft-400">Failed to load activity</p>
			</div>
		)
	}
