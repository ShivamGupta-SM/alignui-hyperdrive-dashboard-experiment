...
const CarouselRoot = React.forwardRef<HTMLDivElement, CarouselRootProps>(
	(
		{ orientation = "horizontal", opts, setApi, plugins, className, children, ...rest },
		forwardedRef
	) => {
...
type CarouselIndicatorGroupProps = Omit<React.HTMLAttributes<HTMLDivElement>, "children"> & {
	children?: React.ReactNode | ((props: { index: number }) => React.ReactNode)
}

function CarouselIndicatorGroup({ className, children, ...rest }: CarouselIndicatorGroupProps) {
