...
export const featuredIconVariants = tv({
	...
	compoundVariants: [
		...
		{ size: "small", theme: "modern-neue", class: { root: "size-8 rounded-lg before:rounded" } },
		{
			size: "medium",
			theme: "modern-neue",
			class: { root: "size-10 rounded-xl before:rounded-md" },
		},
		{
			size: "large",
			theme: "modern-neue",
			class: { root: "size-12 rounded-xl before:rounded-lg" },
		},
		{
			size: "xlarge",
			theme: "modern-neue",
			class: { root: "size-14 rounded-2xl before:rounded-xl" },
		},
		...
		// Gradient theme colors
		{
			theme: "gradient",
			color: "gray",
			class: { root: "before:border-stroke-soft-200 before:bg-bg-weak-50 after:bg-faded-base" },
		},
		{
			theme: "gradient",
			color: "primary",
			class: {
				root: "before:border-primary-lighter before:bg-primary-lighter after:bg-primary-base",
			},
		},
		{
			theme: "gradient",
			color: "error",
			class: { root: "before:border-error-lighter before:bg-error-lighter after:bg-error-base" },
		},
		{
			theme: "gradient",
			color: "warning",
			class: {
				root: "before:border-warning-lighter before:bg-warning-lighter after:bg-warning-base",
			},
		},
		{
			theme: "gradient",
			color: "success",
			class: {
				root: "before:border-success-lighter before:bg-success-lighter after:bg-success-base",
			},
		},
		...
		// Outline theme colors
		{
			...
			color: "gray",
			class: {
				root: "text-text-sub-600 before:border-text-sub-600/30 after:border-text-sub-600/10",
			},
		},
		{
			theme: "outline",
			color: "primary",
			class: {
				root: "text-primary-base before:border-primary-base/30 after:border-primary-base/10",
			},
		},
		{
			theme: "outline",
			color: "error",
			class: { root: "text-error-base before:border-error-base/30 after:border-error-base/10" },
		},
		{
			theme: "outline",
			color: "warning",
			class: {
				root: "text-warning-base before:border-warning-base/30 after:border-warning-base/10",
			},
		},
		{
			theme: "outline",
			color: "success",
			class: {
				root: "text-success-base before:border-success-base/30 after:border-success-base/10",
			},
		},
...
function FeaturedIcon<T extends React.ElementType = "div">({
	...
	return (
		<Component data-featured-icon className={root({ class: className })} {...rest}>
			{renderIcon()}
			{children}
		</Component>
	)
